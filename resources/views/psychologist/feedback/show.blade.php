...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('li_1')
            <a href="{{ route('psychologist.feedback.index') }}">Feedback Review</a>
        @endslot
        @slot('li_2')
            Review Details
        @endslot
                ...
                <div class="col-lg-8 col-xl-9">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('psychologist.feedback.index') }}" class="btn btn-sm btn-secondary">Back to Reviews</a>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <img src="{{ $feedback->patient->user->profile_image ? asset('storage/' . $feedback->patient->user->profile_image) : asset('assets/img/patients/patient.jpg') }}" alt="Patient" class="avatar avatar-lg me-3">
                                        <div>
                                            <h5>{{ $feedback->patient->user->name }}</h5>
                                            <p class="text-muted mb-0">{{ $feedback->patient->user->email }}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
