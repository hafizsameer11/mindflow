        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-xl-9">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form method="GET" action="{{ route('psychologist.feedback.index') }}" class="row g-3">
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="search" placeholder="Search by patient name or comment..." value="{{ request('search') }}">
                                </div>
                                <div class="col-md-2">
                                ...
                                <table class="table table-hover table-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="#" class="avatar avatar-sm me-2">
                                                        <img class="avatar-img rounded-circle" src="{{ $feedback->patient->user->profile_image ? asset('storage/' . $feedback->patient->user->profile_image) : asset('assets/img/patients/patient.jpg') }}" alt="User Image">
                                                    </a>
                                                ...
                                                @if($feedback->comment)
                                                    <div class="comment-preview">
                                                        ...
                                                        @if(strlen($feedback->comment) > 80)
                                                            <a href="{{ route('psychologist.feedback.show', $feedback->id) }}" class="text-primary">Read more...</a>
                                                        @endif
                                                    </div>
                                                @else
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('psychologist.feedback.show', $feedback->id) }}" class="btn btn-sm btn-primary">
