      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <p>This <a class="btn btn-primary popover-test" href="#" role="button" title="" data-content="Popover body content is set in this attribute." data-container="#exampleModalPopovers" data-bs-original-title="Popover title">button</a> triggers a popover on click.</p>
                <hr>
                <h5>Tooltips in a modal</h5>
                <p><a class="tooltip-test" href="#" title="" data-container="#exampleModalPopovers" data-bs-original-title="Tooltip">This link</a> and <a class="tooltip-test" href="#" title="" data-container="#exampleModalPopovers" data-bs-original-title="Tooltip">that link</a> have tooltips on hover.</p>
              </div>
              <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-bs-dismiss="modal" data-bs-original-title="" title="">Close</button>
                <button class="btn btn-primary" type="button" data-bs-original-title="" title="">Save changes</button>
...
@if (Route::is(['doctor-blog']))
		...
		<div class="modal fade" id="deleteNotConfirmModal" tabindex="-1" role="dialog" aria-labelledby="deleteNotConfirmModal" style="display: none;" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
                                ...
                                <div class="col-md-6">
                                    <div class="invoice-info d-flex align-items-center">
                                        <div class="clinic-image d-inline-flex align-items-center justify-content-center">
                                            <img src="{{URL::asset('assets/img/icons/vtaplus.svg')}}" alt="img">
                                        </div>
                                        <div>
                                    ...
                                    <div class="patient-infos d-flex align-items-center justify-content-between gap-3 flex-wrap">
                                        <div class="d-flex align-items-center">
                                            <span class="avatar me-2">
                                                <img src="{{URL::asset('assets/img/doctors-dashboard/profile-06.jpg')}}" class="rounded" alt="img">
                                            </span>
                                            <div>
				...
				<div class="modal-content">
					<div class="modal-body">
						<div class="success-wrap text-center">
							...
							<a href="{{url('appointments')}}" class="btn btn-primary prime-btn">Go to  Appointments</a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="success-wrap">
							...
							<div class="modal-button">
								<div class="row gx-3">
									...
									<div class="col-sm-6">
										<a href="{{url('appointments')}}" class="btn btn-primary prime-btn w-100">Go to  Appointments</a>
									</div>
								</div>
							</div>
						</div>
