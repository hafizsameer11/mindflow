                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="copyright-text">
                                <p class="mb-0">&copy;
                                    ...
                                    </script> Mindflow. All rights reserved.
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
        ...
        <div class="container">
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <div class="copyright-text">
                            <p class="mb-0">Copyright © 2025 Mindflow. All Rights Reserved</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
    ...
    <footer class="footer footer-three footer-ten">
        ...
        <div class="footer-bottom">
            <div class="container">
                ...
                <div class="copyright">
                    <div class="copyright-text">
                        <p class="mb-0">Copyright © 2024 Mindflow. All Rights Reserved</p>
                    </div>
                    <!-- Copyright Menu -->
                    <div class="copyright-menu">
                        <ul class="policy-menu">
            ...
            <div class="container">
                ...
                <div class="copyright">
                    <div class="row align-items-center">
                        <div class="col-xl-5">
                            <div class="copyright-text">
                                <p>Copyright © 2024 Mindflow. All Rights Reserved</p>
                            </div>
                        </div>
                        <div class="col-xl-2">
        ...
        <div class="fooeter-bottom">
            <div class="container">
                <div class="copy-right-footer">
                    <h5>Copyright © 2024 Mindflow. All Rights Reserved</h5>
        ...
        <div class="container">
            ...
            <div class="copyright">
                <div class="row align-items-center">
                    <div class="col-xl-4">
                        <div class="copyright-text">
                            <p>Copyright © 2025 Mindflow. All Rights Reserved</p>
                        </div>
                    </div>
                    <div class="col-xl-3">
                        <div class="footer-bottom-logo">
...
@if (Route::is([
   ...
   <footer class="footer inner-footer">
    <div class="footer-bottom">
        <div class="container">
            <!-- Copyright -->
            <div class="copyright" style="text-align: center !important; display: flex !important; justify-content: center !important; align-items: center !important;">
                <div class="copyright-text" style="text-align: center !important;">
                    <p class="mb-0" style="text-align: center !important; margin: 0 auto;">Copyright © 2025 Mindflow. All Rights Reserved</p>
                </div>
            </div>
            <!-- /Copyright -->					
        </div>
